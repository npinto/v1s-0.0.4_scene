...
representations are combined with the final outputs. Features from
multiscale versions are also used.
"""
...
# -- features from scale 1
r1 = deepcopy(representation)
f1 = deepcopy(featsel)

# -- features from scale 2
r2 = deepcopy(representation)
r2['preproc']['max_edge'] = 75
f2 = deepcopy(featsel)
f2['input_gray'] = (37,37)
